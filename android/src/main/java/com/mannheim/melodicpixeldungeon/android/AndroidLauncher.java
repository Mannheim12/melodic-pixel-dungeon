...
package com.mannheim.melodicpixeldungeon.android;
...
import com.mannheim.melodicpixeldungeon.services.news.NewsImpl;
import com.mannheim.melodicpixeldungeon.services.updates.UpdateImpl;
...
public class AndroidLauncher extends AndroidApplication {
	...
	protected void onCreate (Bundle savedInstanceState) {
		...
		if (instance == null) {
			...
			SPDSettings.set(instance.getPreferences("MelodicPixelDungeon"));
		...
		initialize(new MelodicPixelDungeon(support), config);
