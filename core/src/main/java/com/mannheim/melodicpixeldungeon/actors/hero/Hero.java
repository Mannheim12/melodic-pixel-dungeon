...
import com.mannheim.melodicpixeldungeon.Bones;
import com.mannheim.melodicpixeldungeon.Dungeon;
import com.mannheim.melodicpixeldungeon.GamesInProgress;
import com.mannheim.melodicpixeldungeon.SPDSettings;
import com.mannheim.melodicpixeldungeon.MelodicPixelDungeon;
import com.mannheim.melodicpixeldungeon.Statistics;
import com.mannheim.melodicpixeldungeon.actors.Actor;
import com.mannheim.melodicpixeldungeon.actors.Char;
import com.mannheim.melodicpixeldungeon.actors.blobs.SacrificialFire;
import com.mannheim.melodicpixeldungeon.actors.buffs.AdrenalineSurge;
import com.mannheim.melodicpixeldungeon.actors.buffs.Amok;
import com.mannheim.melodicpixeldungeon.actors.buffs.AnkhInvulnerability;
import com.mannheim.melodicpixeldungeon.actors.buffs.AscensionChallenge;
import com.mannheim.melodicpixeldungeon.actors.buffs.Awareness;
import com.mannheim.melodicpixeldungeon.actors.buffs.Barkskin;
import com.mannheim.melodicpixeldungeon.actors.buffs.Berserk;
import com.mannheim.melodicpixeldungeon.actors.buffs.Bless;
import com.mannheim.melodicpixeldungeon.actors.buffs.Buff;
import com.mannheim.melodicpixeldungeon.actors.buffs.Burning;
import com.mannheim.melodicpixeldungeon.actors.buffs.Combo;
import com.mannheim.melodicpixeldungeon.actors.buffs.Drowsy;
import com.mannheim.melodicpixeldungeon.actors.buffs.Foresight;
import com.mannheim.melodicpixeldungeon.actors.buffs.HoldFast;
...
import com.mannheim.melodicpixeldungeon.actors.buffs.LostInventory;
import com.mannheim.melodicpixeldungeon.actors.buffs.MindVision;
import com.mannheim.melodicpixeldungeon.actors.buffs.Momentum;
import com.mannheim.melodicpixeldungeon.actors.buffs.Paralysis;
import com.mannheim.melodicpixeldungeon.actors.buffs.Regeneration;
import com.mannheim.melodicpixeldungeon.actors.buffs.SnipersMark;
import com.mannheim.melodicpixeldungeon.actors.buffs.Vertigo;
...
import com.mannheim.melodicpixeldungeon.actors.mobs.Monk;
import com.mannheim.melodicpixeldungeon.actors.mobs.Snake;
import com.mannheim.melodicpixeldungeon.effects.CellEmitter;
import com.mannheim.melodicpixeldungeon.effects.CheckedCell;
import com.mannheim.melodicpixeldungeon.effects.Speck;
import com.mannheim.melodicpixeldungeon.effects.SpellSprite;
import com.mannheim.melodicpixeldungeon.items.Amulet;
import com.mannheim.melodicpixeldungeon.items.Ankh;
import com.mannheim.melodicpixeldungeon.items.Dewdrop;
import com.mannheim.melodicpixeldungeon.items.EquipableItem;
import com.mannheim.melodicpixeldungeon.items.Heap;
import com.mannheim.melodicpixeldungeon.items.Heap.Type;
import com.mannheim.melodicpixeldungeon.items.Item;
import com.mannheim.melodicpixeldungeon.items.KindOfWeapon;
import com.mannheim.melodicpixeldungeon.items.armor.Armor;
import com.mannheim.melodicpixeldungeon.items.armor.ClassArmor;
import com.mannheim.melodicpixeldungeon.items.armor.glyphs.AntiMagic;
import com.mannheim.melodicpixeldungeon.items.armor.glyphs.Brimstone;
import com.mannheim.melodicpixeldungeon.items.armor.glyphs.Viscosity;
...
import com.mannheim.melodicpixeldungeon.items.bags.MagicalHolster;
import com.mannheim.melodicpixeldungeon.items.journal.Guidebook;
import com.mannheim.melodicpixeldungeon.items.keys.CrystalKey;
import com.mannheim.melodicpixeldungeon.items.keys.GoldenKey;
import com.mannheim.melodicpixeldungeon.items.keys.IronKey;
import com.mannheim.melodicpixeldungeon.items.keys.Key;
import com.mannheim.melodicpixeldungeon.items.keys.SkeletonKey;
...
import com.mannheim.melodicpixeldungeon.items.potions.elixirs.ElixirOfMight;
import com.mannheim.melodicpixeldungeon.items.potions.exotic.PotionOfDivineInspiration;
...
import com.mannheim.melodicpixeldungeon.items.scrolls.exotic.ScrollOfChallenge;
...
import com.mannheim.melodicpixeldungeon.levels.Level;
import com.mannheim.melodicpixeldungeon.levels.Terrain;
import com.mannheim.melodicpixeldungeon.levels.features.Chasm;
import com.mannheim.melodicpixeldungeon.levels.features.LevelTransition;
import com.mannheim.melodicpixeldungeon.levels.traps.Trap;
import com.mannheim.melodicpixeldungeon.mechanics.ShadowCaster;
import com.mannheim.melodicpixeldungeon.messages.Messages;
import com.mannheim.melodicpixeldungeon.plants.Swiftthistle;
import com.mannheim.melodicpixeldungeon.scenes.AlchemyScene;
import com.mannheim.melodicpixeldungeon.scenes.GameScene;
import com.mannheim.melodicpixeldungeon.scenes.InterlevelScene;
import com.mannheim.melodicpixeldungeon.scenes.SurfaceScene;
import com.mannheim.melodicpixeldungeon.sprites.CharSprite;
...
import com.mannheim.melodicpixeldungeon.ui.AttackIndicator;
import com.mannheim.melodicpixeldungeon.ui.BuffIndicator;
import com.mannheim.melodicpixeldungeon.ui.QuickSlotButton;
import com.mannheim.melodicpixeldungeon.ui.StatusPane;
import com.mannheim.melodicpixeldungeon.utils.GLog;
import com.mannheim.melodicpixeldungeon.windows.WndHero;
import com.mannheim.melodicpixeldungeon.windows.WndMessage;
import com.mannheim.melodicpixeldungeon.windows.WndOptions;
import com.mannheim.melodicpixeldungeon.windows.WndResurrect;
import com.mannheim.melodicpixeldungeon.windows.WndTradeItem;
...
public class Hero extends Char {
	...
	private boolean actAlchemy( HeroAction.Alchemy action ) {
		...
		if (Dungeon.level.distance(dst, pos) <= 1) {
			...
			MelodicPixelDungeon.switchScene(AlchemyScene.class);
			return false;
		...
		if (rooted) {
			...
			if (transition.type == LevelTransition.Type.SURFACE){
				if (belongings.getItem( Amulet.class ) == null) {
					...
					&& Dungeon.initialVersion > MelodicPixelDungeon.v1_2_3
