...
package com.mannheim.melodicpixeldungeon.levels;
...
import com.mannheim.melodicpixeldungeon.actors.blobs.WellWater;
import com.mannheim.melodicpixeldungeon.actors.buffs.Awareness;
import com.mannheim.melodicpixeldungeon.actors.buffs.Blindness;
...
import com.mannheim.melodicpixeldungeon.actors.buffs.LockedFloor;
import com.mannheim.melodicpixeldungeon.actors.buffs.MagicalSight;
import com.mannheim.melodicpixeldungeon.actors.buffs.MindVision;
import com.mannheim.melodicpixeldungeon.actors.buffs.PinCushion;
import com.mannheim.melodicpixeldungeon.actors.buffs.RevealedArea;
import com.mannheim.melodicpixeldungeon.actors.buffs.Shadows;
...
import com.mannheim.melodicpixeldungeon.actors.mobs.Bestiary;
import com.mannheim.melodicpixeldungeon.actors.mobs.Mob;
import com.mannheim.melodicpixeldungeon.actors.mobs.Piranha;
import com.mannheim.melodicpixeldungeon.actors.mobs.YogFist;
import com.mannheim.melodicpixeldungeon.actors.mobs.npcs.Sheep;
import com.mannheim.melodicpixeldungeon.effects.particles.FlowParticle;
import com.mannheim.melodicpixeldungeon.effects.particles.WindParticle;
...
import com.mannheim.melodicpixeldungeon.items.Stylus;
import com.mannheim.melodicpixeldungeon.items.Torch;
...
import com.mannheim.melodicpixeldungeon.levels.features.HighGrass;
import com.mannheim.melodicpixeldungeon.levels.features.LevelTransition;
import com.mannheim.melodicpixeldungeon.levels.painters.Painter;
...
public abstract class Level implements Bundlable {
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		if (version < MelodicPixelDungeon.v1_0_3){
	...
	public Heap drop( Item item, int cell ) {
		...
		if (Dungeon.level != null && MelodicPixelDungeon.scene() instanceof GameScene) {
			pressCell( cell );
		}
