...
import com.mannheim.melodicpixeldungeon.messages.Languages;
import com.mannheim.melodicpixeldungeon.messages.Messages;
import com.mannheim.melodicpixeldungeon.ui.Archs;
...
import com.mannheim.melodicpixeldungeon.ui.ScrollPane;
import com.mannheim.melodicpixeldungeon.ui.StyledButton;
import com.mannheim.melodicpixeldungeon.ui.Window;
import com.mannheim.melodicpixeldungeon.ui.changelist.ChangeInfo;
import com.mannheim.melodicpixeldungeon.ui.changelist.ChangesWindow;
import com.mannheim.melodicpixeldungeon.ui.changelist.v0_1_X_Changes;
import com.mannheim.melodicpixeldungeon.ui.changelist.v0_2_X_Changes;
import com.mannheim.melodicpixeldungeon.ui.changelist.v0_3_X_Changes;
import com.mannheim.melodicpixeldungeon.ui.changelist.v0_4_X_Changes;
import com.mannheim.melodicpixeldungeon.ui.changelist.v0_5_X_Changes;
import com.mannheim.melodicpixeldungeon.ui.changelist.v0_6_X_Changes;
import com.mannheim.melodicpixeldungeon.ui.changelist.v0_7_X_Changes;
import com.mannheim.melodicpixeldungeon.ui.changelist.v0_8_X_Changes;
import com.mannheim.melodicpixeldungeon.ui.changelist.v0_9_X_Changes;
import com.mannheim.melodicpixeldungeon.ui.changelist.v1_X_Changes;
...
public class ChangesScene extends PixelScene {
		...
		StyledButton btn1_1 = new StyledButton(Chrome.Type.GREY_BUTTON_TR, "1.X"){
			...
			protected void onClick() {
				...
				if (changesSelected != 0) {
					changesSelected = 0;
					MelodicPixelDungeon.seamlessResetScene();
				}
			}
		};
	...
	public static void showChangeInfo(Image icon, String title, String message){
		Scene s = MelodicPixelDungeon.scene();
