...
import com.mannheim.melodicpixeldungeon.windows.WndDailies;
import com.mannheim.melodicpixeldungeon.windows.WndError;
import com.mannheim.melodicpixeldungeon.windows.WndRanking;
		...
		if (Rankings.INSTANCE.latestDaily != null) {
			IconButton btnDailies = new IconButton(Icons.CALENDAR.get()) {
				...
				protected void onClick() {
					MelodicPixelDungeon.scene().addToFront(new WndDailies());
				}
