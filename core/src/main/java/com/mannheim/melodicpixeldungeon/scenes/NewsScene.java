...
import com.mannheim.melodicpixeldungeon.services.news.NewsArticle;
...
import com.mannheim.melodicpixeldungeon.windows.WndTitledMessage;
...
public class NewsScene extends PixelScene {
	...
	public void create() {
		...
		StyledButton btnSite = new StyledButton(Chrome.Type.GREY_BUTTON_TR, Messages.get(this, "read_more")){
			...
			protected void onClick() {
				...
				MelodicPixelDungeon.platform.openURI(link);
			}
		};
	...
	private static class ArticleButton extends StyledButton {
		...
		protected void onClick() {
			...
			MelodicPixelDungeon.scene().addToFront(new WndArticle(article));
		}
	}
