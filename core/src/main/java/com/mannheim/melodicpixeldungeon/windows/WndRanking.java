...
import com.mannheim.melodicpixeldungeon.ui.BadgesGrid;
import com.mannheim.melodicpixeldungeon.ui.BadgesList;
...
import com.mannheim.melodicpixeldungeon.ui.ItemSlot;
import com.mannheim.melodicpixeldungeon.ui.RedButton;
import com.mannheim.melodicpixeldungeon.ui.RenderedTextBlock;
import com.mannheim.melodicpixeldungeon.ui.TalentButton;
import com.mannheim.melodicpixeldungeon.ui.TalentsPane;
		...
		public StatsTab() {
			...
			IconButton scoreInfo = new IconButton(Icons.get(Icons.INFO)){
				...
				protected void onClick() {
					super.onClick();
					MelodicPixelDungeon.scene().addToFront(new WndScoreBreakdown());
				}
			};
			...
			if (Dungeon.seed != -1 && !Dungeon.daily &&
				...
				RedButton btnSeed = new RedButton(Messages.get(this, "copy_seed")){
					...
					protected void onClick() {
						super.onClick();
						MelodicPixelDungeon.scene().addToFront(new WndOptions(new Image(icon),
