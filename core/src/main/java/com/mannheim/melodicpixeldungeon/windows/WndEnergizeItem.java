...
public class WndEnergizeItem extends WndInfoItem {
	...
	public static void energize( Item item ) {
		...
		if (MelodicPixelDungeon.scene() instanceof AlchemyScene){
			...
			((AlchemyScene) MelodicPixelDungeon.scene()).createEnergy();
	...
	public static WndBag openItemSelector(){
		if (MelodicPixelDungeon.scene() instanceof GameScene) {
			...
			MelodicPixelDungeon.scene().addToFront(window);
			return window;
		}
	}
		...
		public void onSelect(Item item) {
			if (item != null) {
				...
				if (MelodicPixelDungeon.scene() instanceof GameScene) {
					...
					MelodicPixelDungeon.scene().addToFront(new WndEnergizeItem(item, parentWnd));
				}
			}
		}
	};
