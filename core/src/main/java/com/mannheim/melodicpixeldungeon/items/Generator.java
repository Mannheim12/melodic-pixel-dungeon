...
import com.mannheim.melodicpixeldungeon.items.armor.HuntressArmor;
import com.mannheim.melodicpixeldungeon.items.armor.LeatherArmor;
import com.mannheim.melodicpixeldungeon.items.armor.MageArmor;
import com.mannheim.melodicpixeldungeon.items.armor.MailArmor;
import com.mannheim.melodicpixeldungeon.items.armor.PlateArmor;
import com.mannheim.melodicpixeldungeon.items.armor.RogueArmor;
import com.mannheim.melodicpixeldungeon.items.armor.ScaleArmor;
import com.mannheim.melodicpixeldungeon.items.armor.WarriorArmor;
...
import com.mannheim.melodicpixeldungeon.items.artifacts.ChaliceOfBlood;
import com.mannheim.melodicpixeldungeon.items.artifacts.CloakOfShadows;
import com.mannheim.melodicpixeldungeon.items.artifacts.DriedRose;
import com.mannheim.melodicpixeldungeon.items.artifacts.EtherealChains;
import com.mannheim.melodicpixeldungeon.items.artifacts.HornOfPlenty;
import com.mannheim.melodicpixeldungeon.items.artifacts.MasterThievesArmband;
import com.mannheim.melodicpixeldungeon.items.artifacts.SandalsOfNature;
...
import com.mannheim.melodicpixeldungeon.items.artifacts.UnstableSpellbook;
import com.mannheim.melodicpixeldungeon.items.food.Food;
import com.mannheim.melodicpixeldungeon.items.food.MysteryMeat;
import com.mannheim.melodicpixeldungeon.items.food.Pasty;
import com.mannheim.melodicpixeldungeon.items.potions.Potion;
import com.mannheim.melodicpixeldungeon.items.potions.PotionOfExperience;
import com.mannheim.melodicpixeldungeon.items.potions.PotionOfFrost;
import com.mannheim.melodicpixeldungeon.items.potions.PotionOfHaste;
...
import com.mannheim.melodicpixeldungeon.items.potions.PotionOfLevitation;
...
import com.mannheim.melodicpixeldungeon.items.potions.PotionOfParalyticGas;
import com.mannheim.melodicpixeldungeon.items.potions.PotionOfPurity;
import com.mannheim.melodicpixeldungeon.items.potions.PotionOfStrength;
import com.mannheim.melodicpixeldungeon.items.potions.PotionOfToxicGas;
import com.mannheim.melodicpixeldungeon.items.rings.Ring;
import com.mannheim.melodicpixeldungeon.items.rings.RingOfAccuracy;
import com.mannheim.melodicpixeldungeon.items.rings.RingOfArcana;
import com.mannheim.melodicpixeldungeon.items.rings.RingOfElements;
import com.mannheim.melodicpixeldungeon.items.rings.RingOfEnergy;
import com.mannheim.melodicpixeldungeon.items.rings.RingOfEvasion;
import com.mannheim.melodicpixeldungeon.items.rings.RingOfForce;
import com.mannheim.melodicpixeldungeon.items.rings.RingOfFuror;
import com.mannheim.melodicpixeldungeon.items.rings.RingOfHaste;
import com.mannheim.melodicpixeldungeon.items.rings.RingOfMight;
import com.mannheim.melodicpixeldungeon.items.rings.RingOfSharpshooting;
import com.mannheim.melodicpixeldungeon.items.rings.RingOfTenacity;
...
import com.mannheim.melodicpixeldungeon.items.scrolls.ScrollOfMirrorImage;
import com.mannheim.melodicpixeldungeon.items.scrolls.ScrollOfRage;
import com.mannheim.melodicpixeldungeon.items.scrolls.ScrollOfRecharging;
import com.mannheim.melodicpixeldungeon.items.scrolls.ScrollOfRemoveCurse;
import com.mannheim.melodicpixeldungeon.items.scrolls.ScrollOfRetribution;
...
import com.mannheim.melodicpixeldungeon.items.stones.StoneOfAugmentation;
import com.mannheim.melodicpixeldungeon.items.stones.StoneOfBlast;
import com.mannheim.melodicpixeldungeon.items.stones.StoneOfBlink;
import com.mannheim.melodicpixeldungeon.items.stones.StoneOfClairvoyance;
import com.mannheim.melodicpixeldungeon.items.stones.StoneOfDeepSleep;
import com.mannheim.melodicpixeldungeon.items.stones.StoneOfDisarming;
import com.mannheim.melodicpixeldungeon.items.stones.StoneOfEnchantment;
import com.mannheim.melodicpixeldungeon.items.stones.StoneOfFlock;
import com.mannheim.melodicpixeldungeon.items.stones.StoneOfIntuition;
import com.mannheim.melodicpixeldungeon.items.stones.StoneOfShock;
...
import com.mannheim.melodicpixeldungeon.items.wands.WandOfCorrosion;
import com.mannheim.melodicpixeldungeon.items.wands.WandOfCorruption;
...
import com.mannheim.melodicpixeldungeon.items.weapon.melee.AssassinsBlade;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.BattleAxe;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.Crossbow;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.Dagger;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.Dirk;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.Flail;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.Gauntlet;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.Glaive;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.Gloves;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.Greataxe;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.Greatshield;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.Greatsword;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.HandAxe;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.Longsword;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.Mace;
...
import com.mannheim.melodicpixeldungeon.items.weapon.melee.Quarterstaff;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.RoundShield;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.RunicBlade;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.Sai;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.Scimitar;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.Shortsword;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.Spear;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.Sword;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.WarHammer;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.Whip;
import com.mannheim.melodicpixeldungeon.items.weapon.melee.WornShortsword;
import com.mannheim.melodicpixeldungeon.items.weapon.missiles.Bolas;
import com.mannheim.melodicpixeldungeon.items.weapon.missiles.FishingSpear;
import com.mannheim.melodicpixeldungeon.items.weapon.missiles.ForceCube;
import com.mannheim.melodicpixeldungeon.items.weapon.missiles.HeavyBoomerang;
import com.mannheim.melodicpixeldungeon.items.weapon.missiles.Javelin;
import com.mannheim.melodicpixeldungeon.items.weapon.missiles.Kunai;
import com.mannheim.melodicpixeldungeon.items.weapon.missiles.MissileWeapon;
import com.mannheim.melodicpixeldungeon.items.weapon.missiles.Shuriken;
import com.mannheim.melodicpixeldungeon.items.weapon.missiles.ThrowingClub;
import com.mannheim.melodicpixeldungeon.items.weapon.missiles.ThrowingHammer;
import com.mannheim.melodicpixeldungeon.items.weapon.missiles.ThrowingKnife;
import com.mannheim.melodicpixeldungeon.items.weapon.missiles.ThrowingSpear;
import com.mannheim.melodicpixeldungeon.items.weapon.missiles.ThrowingStone;
import com.mannheim.melodicpixeldungeon.items.weapon.missiles.Tomahawk;
import com.mannheim.melodicpixeldungeon.items.weapon.missiles.Trident;
import com.mannheim.melodicpixeldungeon.plants.Blindweed;
import com.mannheim.melodicpixeldungeon.plants.Mageroyal;
import com.mannheim.melodicpixeldungeon.plants.Earthroot;
import com.mannheim.melodicpixeldungeon.plants.Fadeleaf;
import com.mannheim.melodicpixeldungeon.plants.Firebloom;
import com.mannheim.melodicpixeldungeon.plants.Icecap;
import com.mannheim.melodicpixeldungeon.plants.Plant;
import com.mannheim.melodicpixeldungeon.plants.Rotberry;
import com.mannheim.melodicpixeldungeon.plants.Sorrowmoss;
import com.mannheim.melodicpixeldungeon.plants.Starflower;
import com.mannheim.melodicpixeldungeon.plants.Stormvine;
import com.mannheim.melodicpixeldungeon.plants.Sungrass;
