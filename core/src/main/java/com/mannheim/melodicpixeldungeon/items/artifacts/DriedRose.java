...
package com.mannheim.melodicpixeldungeon.items.artifacts;
...
import com.mannheim.melodicpixeldungeon.actors.hero.Belongings;
...
import com.mannheim.melodicpixeldungeon.effects.particles.ShaftParticle;
...
import com.mannheim.melodicpixeldungeon.scenes.CellSelector;
import com.mannheim.melodicpixeldungeon.scenes.GameScene;
import com.mannheim.melodicpixeldungeon.scenes.PixelScene;
import com.mannheim.melodicpixeldungeon.sprites.GhostSprite;
...
import com.mannheim.melodicpixeldungeon.windows.IconTitle;
import com.mannheim.melodicpixeldungeon.windows.WndBag;
import com.mannheim.melodicpixeldungeon.windows.WndBlacksmith;
import com.mannheim.melodicpixeldungeon.windows.WndQuest;
...
public class DriedRose extends Artifact {
	...
	public static class GhostHero extends DirectableAlly {
		...
		public void sayAppeared(){
			...
			if (MelodicPixelDungeon.scene() instanceof GameScene) {
				Sample.INSTANCE.play( Assets.Sounds.GHOST );
			}
		}
