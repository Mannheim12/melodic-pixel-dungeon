...
package com.mannheim.melodicpixeldungeon.desktop;
	...
	public static void main (String[] args) {
		...
		Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
			...
			public void uncaughtException(Thread thread, Throwable throwable) {
				...
				exceptionMsg = exceptionMsg.replace("com.mannheim.melodicpixeldungeon.", "");
		...
		new Lwjgl3Application(new MelodicPixelDungeon(new DesktopPlatformSupport()), config);
	}
}
